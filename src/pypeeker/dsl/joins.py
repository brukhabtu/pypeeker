...
Both set kinds resolve through :meth:`pypeeker.dsl.Corpus.materialize`, keyed
...
class ProjectedSet:
    ...
    def cache_key(self) -> Hashable:
        """Structural identity of this set, for :meth:`pypeeker.dsl.Corpus.materialize`.
    ...
    def values(self, corpus: Corpus) -> frozenset[Any]:
        ...
        """
        return corpus.materialize(self.cache_key, lambda: self._compute(corpus))
...
class CorpusSet:
    ...
    def values(self, corpus: Corpus) -> frozenset[Any]:
        ...
        """
        return corpus.materialize(self.cache_key, lambda: frozenset(self.load(corpus)))
