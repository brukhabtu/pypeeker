...
from pypeeker.dsl.errors import OpaquePredicateError, ReachError, UnknownTraitError
...
class EvalContext:
    ...
    *a falsy value produced under this context never reaches a reported
    ...
    def consuming_falsity(self) -> EvalContext:
        ...
        later, and the fields it would drop are exactly the project-reach
        substrate that :class:`Not`, :class:`Compare` and :class:`Attr` sit on
        top of.
        """
