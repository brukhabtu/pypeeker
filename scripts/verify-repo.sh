#!/bin/bash
# One-shot full gate for pypeeker: runs the three checks CI runs (test suite,
# lint, self-lint) and reports a compact PASS/FAIL per step plus a final
# summary. This is the canonical thing to run before calling a change done —
